...
const IndexPage = () => (
    <Layout>
        ...
        <p>
            ...
            property rights related to it, still belong to Sam Davis.
        </p>
        <p>
            Sam Davis is committed to ensuring that the app is as useful and
        ...
        <p>
            The Sweather app stores and processes personal data that you have
            ...
            mean that the Sweather app won’t work properly or at all.
        </p>
        <div>
            <p>
        ...
        <p>
            You should be aware that there are certain things that Sam Davis
            ...
            provider, but Sam Davis cannot take responsibility for the app not
        ...
        <p>
            Along the same lines, Sam Davis cannot always take responsibility
            ...
            it on to avail the Service, Sam Davis cannot accept responsibility.
        </p>
        <p>
            With respect to Sam Davis’s responsibility for your use of the app,
            ...
            so that we can make it available to you. Sam Davis accepts no
        ...
        <p>
            ...
            to keep using the app. Sam Davis does not promise that it will
            always update the app so that it is relevant to you and/or works
            with the iOS version that you have installed on your device.
        ...
        <p>These terms and conditions are effective as of 2020-06-27</p>
        <p>
            <strong>Contact Us</strong>
        </p>
        <p>
            If you have any questions or suggestions about my Terms and
            Conditions, do not hesitate to contact me at sam@sjd.co.
        </p>
    </Layout>
);
